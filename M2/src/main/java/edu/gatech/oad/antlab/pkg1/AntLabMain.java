 ...
 */
 public class AntLabMain {
    ...
    public void printOutMessage() {
    	...
    	Person1 p1 = new Person1("Andrew Chang");
    	toPrint += p1.toString("achang66");
    	//Person2 replace P2 with your name
    	//and gburdell with your gt id
    	Person2 p2 = new Person2("Ryan Qin");
    	toPrint += p2.toString("rqin37");
    	//Person3 replace P3 with your name
    	//and gburdell3 with your gt id
    	Person3 p3 = new Person3("Chunjun Jia");
    	toPrint += p3.toString("cjia9");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("Yayun Huang");
        toPrint += p4.toString("yhuang481");
        //Person5 replace P5 with your name
        //and gburdell5 with your gt id
        Person5 p5 = new Person5("Xiaoyu Gu");
        toPrint += p5.toString("xgu79");
        //Person6 replace P6 with your name
        //and gburdell6 with your gt id
        Person6 p6 = new Person6("Zhuo Jiang");
        toPrint += p6.toString("zjiang307");
     ...
     *
     * @param args the array of arguments to be passed into the main function
     *
     */
